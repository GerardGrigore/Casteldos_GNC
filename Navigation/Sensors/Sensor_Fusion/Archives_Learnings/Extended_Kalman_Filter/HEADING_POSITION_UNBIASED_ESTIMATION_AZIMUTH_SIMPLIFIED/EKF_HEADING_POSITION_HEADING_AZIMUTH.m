function [STATE_APOSTERIORI_CURRENT,COVARIANCE_APOSTERIORI_CURRENT] = EKF_HEADING_POSITION_HEADING_AZIMUTH(STATES_INITIAL,COVARIANCE_STATES_INITIAL,CONTROL_INPUTS_INITIAL,...
