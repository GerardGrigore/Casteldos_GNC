...
Position_X_Current = Position_X_Previous + Velocity_Previous*Time_Step_HW*sin(Psi_Heading_Previous);
Position_Y_Current = Position_Y_Previous + Velocity_Previous*Time_Step_HW*cos(Psi_Heading_Previous);
