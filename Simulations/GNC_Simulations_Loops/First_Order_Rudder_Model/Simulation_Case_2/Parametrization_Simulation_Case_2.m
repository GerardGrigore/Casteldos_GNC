...
% Parametrization script associated with the 'Simulator_Case_2' Simulink
...
% and data fusion.
% * Environment: waves (and partly winds) considered.
...
run(Path_Casteldos_GNC_Software + "Casteldos_GNC_Software\Control\Controller\PID\PID_Tuning_Case_0.m");
% PIDF Synthesis launch:
run(Path_Casteldos_GNC_Software + "Casteldos_GNC_Software\Control\Controller\PID\PID_Tuning_Case_1.m");
% Wind generation:
