...
run(Path_Casteldos_GNC_Software + "Casteldos_GNC\Control\Controller\LQR\LQR_Tuning_Heading_Control.m");
...
addpath(genpath(Path_Casteldos_GNC_Software + "Casteldos_GNC\Control\Controller\LQR"));
